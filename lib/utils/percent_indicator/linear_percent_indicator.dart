...
class _LinearPercentIndicatorState extends State<LinearPercentIndicator>
  ...
  Widget build(BuildContext context) {
    ...
    var containerWidget = Stack(
      alignment: Alignment.center,
      children: [
        Container(width: hasSetWidth ? widget.width!+35.5 : double.infinity,
          height: widget.lineHeight!+35.5,),
        ClipRRect(
        ...
        Positioned(
          right: widget.isRTL ? percentPositionedHorizontal : null,
          left: !widget.isRTL ? percentPositionedHorizontal : null,
          top: widget.isForMobile?_containerHeight / 1 - _indicatorHeight+13:_containerHeight / 1 - _indicatorHeight-2,
          child: Container(
            width: widget.isForMobile?15:26,
            height: widget.isForMobile?15:26,
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
              color: Colors.greenAccent,
              border: Border.all(color: Color(0xFF0A2342))
            ),
          ),
        ),
        // Positioned(
        //   right: widget.isRTL ? percentPositionedHorizontal+4.5 : null,
        //   left: !widget.isRTL ? percentPositionedHorizontal+4.5 : null,
        //   top: _containerHeight / 2 - _indicatorHeight+2,
        //   child: Container(
        //     width: 8,
        //     height: 8,
        ...
        // ),
        // (widget.center != null)
        //     ? Container(height: 16,width: 16,child: widget.center,decoration: BoxDecoration(shape: OvalBorder(),),)
        //     : const Offstage(),
      ],
    );
