...
class ScreenConstant {
  ...
  static double defaultHeightTwentyTwo = 22;
  ...
  static double defaultHeightThreeHundredFifty = 350;
  static double defaultHeightThreeHundred = 300;
  static double defaultHeightThirty = 30;
  static double defaultHeightFifty = 50;
  static double defaultHeightThirtyFive = 35;
  static double defaultHeightOneSixty = 160.0;
  static double defaultHeightSevenHundred = 700.0;
  ...
  static double defaultWidthSeventySix = 76;
  static double defaultWidthNinety = 90;
  static double defaultWidthThirty = 30;
  static double defaultWidthForty = 40;
  static double defaultWidthOneThirty = 130;
  static double defaultWidthOneFifty = 150;
  static double defaultWidthOneTen = 110;
  static double defaultWidthTwoEightyFive = 285;
  static double defaultWidthFourHundred = 400;
  static double defaultWidthEightHundred = 800;
  ...
  static void setScreenAwareConstant(context) {
    ...
    defaultHeightTwentyTwo = DeviceManager.instance.setHeight(22.0);
    ...
    defaultHeightThreeHundredFifty = DeviceManager.instance.setHeight(350.0);
    defaultHeightThreeHundred = DeviceManager.instance.setHeight(300.0);
    ...
    defaultHeightThirtyFive = DeviceManager.instance.setHeight(35.0);
    defaultHeightFifty = DeviceManager.instance.setHeight(50.0);
    defaultHeightOneSixty = DeviceManager.instance.setHeight(160.0);
    defaultHeightSevenHundred = DeviceManager.instance.setHeight(700.0);
    /* Nimmio Default Width*/
    ...
    defaultWidthSeventySix = DeviceManager.instance.setWidth(76.0);
    defaultWidthNinety = DeviceManager.instance.setWidth(90.0);
    defaultWidthThirty = DeviceManager.instance.setWidth(30.0);
    defaultWidthForty = DeviceManager.instance.setWidth(40.0);
    defaultWidthOneThirty = DeviceManager.instance.setWidth(130.0);
    defaultWidthOneFifty = DeviceManager.instance.setWidth(150.0);
    defaultWidthOneTen = DeviceManager.instance.setWidth(110.0);
    defaultWidthTwoEightyFive = DeviceManager.instance.setWidth(285.0);
    defaultWidthFourHundred = DeviceManager.instance.setWidth(400.0);
    defaultWidthEightHundred = DeviceManager.instance.setWidth(800.0);
  }
}
