...
class AddExpensesScreenTablet extends StatelessWidget {
  AddExpensesScreenTablet({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return isLandscape?Scaffold(
      ...
      leadingWidth: getTabletHorizontalSize(150),
      leading: Row(
    ...
    body: Container(   decoration: BoxDecoration(color: Color(0xFF1E1E1E).withOpacity(0.1),),child: Padding(padding: EdgeInsets.symmetric(horizontal: 30),child: ListView(
      children: [
        Container(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: getTabletPadding(left: 40),
                  child: Text(
                    "Project Name :",
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        width: getTabletHorizontalSize(15),
                      ),
                      Text(
                        "Property no: ",
                ...
                Padding(
                  padding: getTabletPadding(left: 40,right: 40),
                  child: DropdownButtonFormField(
                    decoration: InputDecoration(
                      filled: true,
                      fillColor: Colors.white,
                      contentPadding: getTabletPadding(all: 20),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        width: getTabletHorizontalSize(40),
                      ),
                      Expanded(
                        flex: 6,
                        child: TextFormField(
                ...
                Padding(
                  padding: getTabletPadding(left: 40,right: 40),
                  child: Obx(()=> _authenticationController
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: getTabletPadding(all: 40),
                        child: Row(
                          children: [
                            Expanded(
                              flex: 5,
                            ...
                            Container(
                              width: getTabletHorizontalSize(50),
                            ),
                            Expanded(
                              flex: 5,
                              child: Column(
                      ...
                      Padding(
                        padding:
                        getTabletPadding(left: 40, bottom: 40, right: 40),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Expanded(
