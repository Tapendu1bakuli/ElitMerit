...
import '../../widget/mobile/timeline_widget_mobile.dart';
import '../../widget/tablet/timline_tablet_widget.dart';

class ProgressDetailTablet extends StatelessWidget {
   ProgressDetailTablet({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return isLandscape?Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: CustomTextStyles.bold28Tablet,
        ),
        leading: Padding(
      ...
      body: _bodyViewPortrait(context),
    ):Scaffold(
      appBar: AppBar(
      scrolledUnderElevation: 0.0,
      leadingWidth: 200,
   ...
   Widget _bodyViewPortrait(BuildContext context){
     return Container(
       ...
       child:  SingleChildScrollView(
         child: Column(
           ...
           children: [
             _tabButtonViewPortrait(),
             SizedBox(height: getTabletSize(40),),
             _detailedViewPortrait(context),
             SizedBox(height: getTabletSize(40),),
             _dealsUpdateViewPortrait(),
             SizedBox(height: getTabletSize(40),),
             _brokerChatView(),
             SizedBox(height: getTabletSize(40),),
             _fileManagementViewPortrait(context),
             SizedBox(height: getTabletSize(40),),
           ],
         ),
       ),
   ...
   Widget _detailedViewPortrait(context){
     return Container(
   ...
   Widget _dealsUpdateViewPortrait(){
     return Container(
       ...
       child: Column(
         children: [
           ...
           AppButton(
             ...
             elevation: 0,
             width: Get.width/6,
             height: getTabletVerticalSize(40),
   ...
   Widget _fileManagementViewPortrait(context){
     return Container(
       width: MediaQuery.of(context).size.width,
       decoration: BoxDecoration(
         color: AppColors.whiteColor,
       ...
       child: Column(
         children: [
           ...
           SizedBox(height: getTabletSize(40),),
           _tableHeadingPortrait(),
           ListView.builder(
               itemCount: 4,
               shrinkWrap: true,
               physics: const NeverScrollableScrollPhysics(),
               itemBuilder: (context,int index){
                 return _tableItemsViewPortrait();
               }),
   ...
   Widget _tableItemsViewPortrait() {
     return Table(
       defaultVerticalAlignment: TableCellVerticalAlignment.middle,
       columnWidths: const {
       ...
       children: [
         TableRow(
             ...
             children: [
               ...
               Padding(
                 padding:
                 EdgeInsets.only(top: 10.0.ss, bottom: 10.ss,left: 30.ss),
                 child: Text('John',
                     textAlign: TextAlign.start,
                     style: GoogleFonts.poppins(
                         textStyle: TextStyle(
      ...
      child: Column(
        children: [
          ...
          AppButton(
            ...
            elevation: 0,
            width: Get.width/6,
            height: getTabletVerticalSize(60),
            textStyle: CustomTextStyles.customButtonTextStyleTablet,
          ),
          SizedBox(height: 20.ss,),
        ],
