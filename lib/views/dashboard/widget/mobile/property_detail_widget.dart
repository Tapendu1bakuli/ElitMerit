...
class PropertyDetailWidget extends StatelessWidget {
   PropertyDetailWidget({super.key});
        ...
        Obx(()=>_homeController.activeIndex.value!=0? Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ClipRRect(borderRadius: BorderRadius.circular(20),child: Container(height: 10,width: 10,decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: _homeController.activeIndex.value==index?Colors.white:Color(0xFF0A2342),border: Border.all(color: Color(0xFF0A2342))),));
              },
            ),
          ): Container(
          margin: EdgeInsets.symmetric(horizontal: 10.ss),
...
,        SizedBox(
        ...
        child: Row(
          children: [
            Expanded(flex:3,child: Column(crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment:MainAxisAlignment.center,children: [
              ...
              Text("Call",style: CustomTextStyles.medium12Mobile,)
            ],)),
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text(
                  title,
                  style: CustomTextStyles.light8Mobile,
                ),
                Expanded(
                  child: Text(
                    roomNumber,
                    style: CustomTextStyles.medium8Mobile,
                  ),
                ),
              ],
            ),
  ...
  Widget _toggleButtonView() {
    return Container(
      height: 40.ss,
      width: ScreenConstant.screenHeightThird-30,
      alignment: Alignment.center,
      decoration: BoxDecoration(
        color: AppColors.darkBlueColor,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(
              'For Sale:',
              style: CustomTextStyles.medium14FFFFFFMobile,
            ),
          ),
          Expanded(
            child: Text(
