...
class AddPropertyTabletPortraitCardWidget extends StatelessWidget {
  String? image;
  String? title;
  Function()? onTap;
  bool? isColoured;
  AddPropertyTabletPortraitCardWidget({Key? key,this.isColoured,this.onTap,this.image,this.title}) : super(key: key);
