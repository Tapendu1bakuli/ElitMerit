...
class AddLeaseContractTabletPortraitWidget extends StatelessWidget {
  AddLeaseContractTabletPortraitWidget({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                _propertyInfoTextView(
                    title: 'Project Name', subTitle: 'Excepteur sint occaecat',textStyle: CustomTextStyles.light20000000TextStyleTablet.copyWith(
                    fontSize : 14.fss
                ),),
                _propertyInfoTextView(
                    title: 'Property Number', subTitle: '1245e25',textStyle:CustomTextStyles.light20000000TextStyleTablet.copyWith(
                    fontSize : 14.fss
                ),),
                _propertyInfoTextView(
                    title: 'Room Count', subTitle: '03',textStyle: CustomTextStyles.light20000000TextStyleTablet.copyWith(
                    fontSize : 14.fss
                ),),
                _propertyInfoTextView(
                    title: 'Type', subTitle: 'Apartment',textStyle: CustomTextStyles.light20000000TextStyleTablet.copyWith(
                    fontSize : 14.fss
                ),),
                _propertyInfoTextView(
                    title: 'Condition',
      ...
      child: Row(
        children: [
          Expanded(
            ...
            child: Text(
              title,
              style: CustomTextStyles.light20000000TextStyleTablet.copyWith(
                fontSize : 14.fss
              ),
            ),
          ),
