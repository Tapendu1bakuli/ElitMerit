...
import 'add_property_tablet_card_widget.dart';

class FilterWidgetTablet extends StatelessWidget {
  FilterWidgetTablet({super.key});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            //                           //               flex: 3,
            //                           //               child: Container(
            //                           //                 padding: getTabletPadding(right: 5),
            //                           //                 child: _decoratedContainer(
            //                           //                     title: 'Full',
            //                           //                     fontColor: AppColors
            //                           //                         .whiteColor,
            ...
            CommonCardMobile(
              child: Column(
                ...
                children: [
                  ...
                  Center(child: _propertyTypeListView1()),
                ],
              ),
            ),
            SizedBox(
    ...
    return Container(
      ...
      child: Center(
        child: TextFormField(
          ...
          decoration: InputDecoration(
            contentPadding: EdgeInsets.only(top: 15.ss),
            fillColor: const Color(0xFFF6F8FA),
            filled: true,
            hintText: "Search",
            hintStyle: CustomTextStyles.medium156A6A6ATablet,
            ...
            focusedBorder: const OutlineInputBorder(
              ...
              borderSide: BorderSide(
                  color: Color(0xFFF6F8FA), width: 1, style: BorderStyle.solid),
            ),
            disabledBorder: const OutlineInputBorder(
              borderRadius: BorderRadius.all(Radius.circular(10)),
              borderSide: BorderSide(
                  color: Color(0xFFEAF0F5), width: 1, style: BorderStyle.solid),
            ),
  ...
  Widget _propertyTypeListView() {
    ...
    List<String> listIcon = [
      'asset/icons/tablet/apartment_mobile.svg',
      'asset/icons/tablet/villa_mobile.svg',
      'asset/icons/tablet/hotel_apartment_mobile.svg',
      'asset/icons/tablet/townhouse_mobile.svg'
    ];
    return  Obx(
          () => GridView.count(
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(height: getTabletSize(15)),
                  _titleWidget(
    ...
    //         );
    //       }, separatorBuilder: (BuildContext context, int index) { return Container(width: getTabletSize(20),); },),
    // );
  }
  ...
  Widget _socialShareListView() {
    ...
    List<String> listIcon = [
      'asset/icons/tablet/phone-outgoing.svg',
      'asset/icons/tablet/ic_whatsp.svg',
      'asset/icons/tablet/envelope-one.svg',
      'asset/icons/tablet/wechat.svg'
    ];
    return SizedBox(
      height: 70.ss,
  ...
  Widget _decoratedContainer(
    ...
    return Container(
      alignment: Alignment.center,
      // padding: getTabletPadding(left: 15, right: 20, bottom: 10, top: 10),
      decoration: BoxDecoration(
  ...
  Widget _toggleButtonView(
      {double? minWidth, double? minHeight, required List<String> labels}) {
    return ToggleSwitch(
      minWidth: minWidth ?? getTabletSize(150),
      minHeight: minHeight ?? getTabletSize(50),
    ...
    return  Obx(
          ...
          children: List.generate(
            ...
            return InkWell(
              ...
              child: Container(
                margin: EdgeInsets.symmetric(horizontal: 10.ss,vertical: 15.ss),
          ...
          itemBuilder: (context, int index) {
            return InkWell(
              ...
              child: Container(
                ...
                margin: getTabletPadding(right: 7),
                height: 35,
                width: 40,
                alignment: Alignment.center,
                decoration: BoxDecoration(
