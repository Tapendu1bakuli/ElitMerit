...
class AddLeaseContractTabletWidget extends StatelessWidget {
  AddLeaseContractTabletWidget({Key? key}) : super(key: key);
  ...
  Widget _bodyView(context) {
    return Stack(
      children: [
              ...
              children: [
                CommonCardTablet(
                  ...
                  child: Text(
                    ...
                    style: CustomTextStyles.medium18FFFFFFTextStyleTablet,
                  ),
                ),
                SizedBox(height: 20.ss),
                _propertyInfoTextView(
                    title: 'Project Name', subTitle: 'Excepteur sint occaecat',textStyle: CustomTextStyles.light20000000TextStyleTablet),
                _propertyInfoTextView(
                    title: 'Property Number', subTitle: '1245e25',textStyle:CustomTextStyles.light20000000TextStyleTablet),
                _propertyInfoTextView(title: 'Room Count', subTitle: '03',textStyle: CustomTextStyles.light20000000TextStyleTablet),
                _propertyInfoTextView(title: 'Type', subTitle: 'Apartment',textStyle: CustomTextStyles.light20000000TextStyleTablet),
                _propertyInfoTextView(
                    title: 'Condition',
                    subTitle: 'Good',
                    textStyle: CustomTextStyles.semiBold20TextStyleTablet),
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Tenant',style: CustomTextStyles.medium200A2342TextStyleTablet,),
                          SizedBox(height: 10.ss),
                          Container(
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: CustomTextStyles.medium146A6A6ATextStyleTablet,
                                errorStyle: TextStyle(
                                    color: const Color(0xFFE8503A),
                                    fontSize: 12.fss,
                                    fontFamily: 'Gordita'),
                                suffixIcon: Padding(
                                  padding: getTabletPadding(right: 10,top: 10,bottom: 10),
                                  child:  Image.asset("asset/icons/tablet/User_alt_light.png",height: getTabletSize(28),),
                                ),
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: Padding(
                                  ...
                                  child: Image.asset("asset/icons/tablet/download_11.png",height:20),
                                ),
                            ...
                            child: Obx(()=>TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: Padding(
                                  ...
                                  child:  Image.asset("asset/icons/tablet/download_3.png", height:20,),
                                ),
                          ...
                          Text(
                            'Contract Date',
                            style: CustomTextStyles.medium200A2342TextStyleTablet,
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child:  Image.asset("asset/icons/tablet/download_9.png", height:20,),
                                ),
                                focusedBorder: OutlineInputBorder(
                                  borderRadius:
                                  const BorderRadius.all(Radius.circular(10)),
                    ...
                    Container(width: getTabletSize(80),),
                    Expanded(
                      flex: 1,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          CustomPaint(
                            painter: ArcPainter(
                              start: Offset(ScreenConstant.defaultHeightForty, ScreenConstant.defaultHeightTwentyThree+10), // Adjust these values based on the positions of the text fields
        ...
        // Positioned(
        //   right: getTabletHorizontalSize(508),
        //   top: Get.height * 0.95,
        //   child: Image.asset(
        //     "asset/icons/tablet/bubble_half.png",
        //     height: getTabletSize(400),
        //   ),
        // ),
      ],
    );
        ...
        child: DottedBorder(
          ...
          child: Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Expanded(flex:7,child: FittedBox(
                  child: Text(
                ...
                Expanded(flex:3,child:  DottedBorder(
                  borderType: BorderType.RRect,
