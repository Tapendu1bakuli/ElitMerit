...
class PropertyCardWidgetWeb extends StatelessWidget {
  const PropertyCardWidgetWeb({Key? key}) : super(key: key);
                    ...
                    child: CustomElevatedContainerForFavourites(
                        ...
                        richText: RichText(
                          text: TextSpan(
                            text: 'For Sale :',
                            style:
                            CustomTextStyles.light14WithoutFssFFFFFFTextStyleTablet,
                            children: [
                              TextSpan(
                                text: ' 54,300,000 AED    ',
                                style:
